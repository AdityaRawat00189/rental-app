...
//     } catch (error) {
//       alert("Protocol Error: Failed to mark as returned.");
//     }
//   };
...
//       const token = currentUser?.token;
//       const BASE_URL = import.meta.env.VITE_BASE_URL;
//       // Replace with your actual backend endpoint for penalty initiation
...
//     }).sort((a, b) => new Date(a.endDate) - new Date(b.endDate)); // Sort by closest deadline
...
//       return (b.owner?._id === currentUserId || b.renter?._id === currentUserId);
//     }).sort((a, b) => new Date(b.endDate) - new Date(a.endDate)); // Sort newest completed first
//   }, [bookings, currentUserId]);
...
//                         className={`group border p-6 rounded-[2rem] flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition-all ${
//                           isOverdue 
...
//                         {/* Logistics */}
//                         <div className="w-full md:w-[30%] px-4 border-l border-white/5">
...
//                         {/* Actions */}
//                         <div className="w-full md:w-[40%] flex flex-col items-start md:items-end gap-3">
...
//                               >
//                                 <AlertOctagon size={14} /> Initiate Penalty
//                               </button>
//                             )}
...
//                               className={`w-full sm:w-auto py-2.5 px-4 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
//                                 isOverdue
...
//                         {/* Logistics */}
//                         <div className="w-full md:w-1/3 px-4 border-l border-white/5">
